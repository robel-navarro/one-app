 ...
 <div class="content-header">
     <div class="container-fluid">
         <div class="row mb-2">
             <div class="col-sm-6">
                 <h1 class="m-0">Product Number Revision</h1>
             </div>
             <div class="col-sm-6">
         ...
         <div class="row">
                 ...
                 <div class="card">
                     ...
                     <div class="card-body">
                         ...
                         <div class="form-group row" style="display:flex;justify-content:flex-end;gap:20px;">
                             <div class="col-sm-2">
                                 <button type="button" id="add_pn_rev" class="btn btn-block bg-gradient-success">Add New</button>
                             </div>
             ...
             <section class="col-lg-6 connectedSortable">
                 <div class="card">
                     ...
                     <div class="card-body">
                         <div class="row">
                             <table id="pn_rev_table" class="table table-bordered table-striped">
                                 <thead>
                                     <tr>
                                         <th>No.</th>
                                         <th>Part Number</th>
 ...
 <script>
     ...
     $(document).ready(function() {
         pnRevTable = $("#pn_rev_table").DataTable({
             responsive: true,
             lengthChange: false,
             autoWidth: false
         });
     ...
     function LoadPNREVRecord() {
         $('#pn_rev_table_body').empty();
         $.post('pn_rev/route/pn_rev.php', {
             action: 'getPNREV',
         }, function(data) {
         ...
         $(document).on("click", ".btn-update", function() {
            ...
            <div class="swal-form">
                ...
                <input id="swal-pn" class="swal2-input" value="1000000361" disabled>
                </div>

                <div class="swal-row">
                <div class="swal-group">
                    <label>Revision</label>
                    <input id="swal-rev" class="swal2-input" value="01">
                </div>
